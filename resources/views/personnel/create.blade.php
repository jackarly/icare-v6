            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('personnel.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-2">
                                <input id="personnel_mid_name" type="text" class="form-control @error('personnel_mid_name') is-invalid @enderror" name="personnel_mid_name" value="{{ old('personnel_mid_name') }}" required autocomplete="personnel_mid_name" autofocus placeholder="Mid Name">
                            ...
                            <div class="col-md-2">
                                <input id="personnel_last_name" type="text" class="form-control @error('personnel_last_name') is-invalid @enderror" name="personnel_last_name" value="{{ old('personnel_last_name') }}" required autocomplete="personnel_last_name" autofocus placeholder="Last Name">
